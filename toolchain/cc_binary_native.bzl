...
# ---------------------- Rule implementation ---------------------- #
def _cc_binary_native_impl(ctx):
    # Declare executable
    ...
    default_info = DefaultInfo(executable = linking_outputs.executable)
...
# ---------------------- Rule definition ---------------------- #
cc_binary_native = rule(
    implementation = _cc_binary_native_impl,
    attrs = {
